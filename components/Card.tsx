...
const Card: React.FC = () => {
  return (
    <div className="h-[422px] w-[378.56px] cursor-pointer hover:shadow-md hover:rounded-lg">
      <Image className="rounded-lg" src="/assets/images/house.png" width={378} height={299} alt="house image" priority />
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center">
          <Image src="/assets/images/star.png" width={20} height={20} alt="star" priority />
